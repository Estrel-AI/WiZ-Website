module.exports=[873,a=>{"use strict";var b=a.i(87924);let c=(0,a.i(70106).default)("download",[["path",{d:"M12 15V3",key:"m9g1x1"}],["path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4",key:"ih7n3h"}],["path",{d:"m7 10 5 5 5-5",key:"brsn70"}]]);var d=a.i(33508),e=a.i(72131),f=a.i(50944);let g={terms:{title:"Terms and Conditions",content:`Beta Terms and Conditions - WiiZ 2.0 (Beta)
...
`},privacy:{title:"Privacy Policy",content:`Privacy Policy - WiiZ 2.0 (Beta)
Policy Version: 2.0
Last Updated: 14 May 2026
...
If users do not agree with this Privacy Policy, they should discontinue use of the Platform.`},cookies:{title:"Cookie Policy",content:`Cookie Policy - WiiZ 2.0 (Beta)
Policy Version: 1.0
Last Updated: 14 May 2026
...
`}},h="wiiz_cookie_consent",i="2026-05-14";function j({openPolicy:a}){let[c,d]=(0,e.useState)(!1),[f,g]=(0,e.useState)(!1);async function j(a){let b=JSON.stringify({decision:a,version:i,timestamp:new Date().toISOString()});g(!0);try{window.localStorage.setItem(h,b),document.cookie=`wiiz_cookie_consent=${encodeURIComponent(b)}; path=/; max-age=15552000; samesite=lax`}finally{g(!1),d(!1)}}return((0,e.useEffect)(()=>{let a=function(){var a=window.localStorage.getItem(h);if(!a)return null;try{return JSON.parse(a)}catch{return null}}();d(a?.version!==i)},[]),c)?(0,b.jsx)("div",{className:"fixed inset-x-0 bottom-0 z-[110] px-4 pb-4 sm:px-6 lg:px-8",children:(0,b.jsx)("div",{className:"mx-auto max-w-6xl rounded-[1.75rem] border border-secondary/45 bg-[linear-gradient(140deg,rgba(24,13,23,0.98)_0%,rgba(37,18,33,0.98)_55%,rgba(58,22,46,0.98)_100%)] p-5 text-white shadow-[0_34px_90px_rgba(0,0,0,0.5),0_0_0_1px_rgba(216,122,170,0.15)] backdrop-blur xl:p-6",children:(0,b.jsxs)("div",{className:"flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between",children:[(0,b.jsxs)("div",{className:"max-w-3xl",children:[(0,b.jsx)("p",{className:"text-[11px] font-semibold uppercase tracking-[0.24em] text-secondary",children:"Cookie Preferences"}),(0,b.jsx)("h2",{className:"mt-2 text-lg font-semibold md:text-xl",children:"We use cookies for essential site operation, preferences, and consent tracking."}),(0,b.jsx)("p",{className:"mt-2 text-sm leading-relaxed text-slate-300 md:text-[15px]",children:"You can accept all cookies we use on this site, or continue with essential cookies only. Your choice is recorded with the current policy version."}),(0,b.jsx)("button",{type:"button",onClick:()=>a("cookies"),className:"mt-3 text-sm font-medium text-secondary transition hover:text-white",children:"Review Cookie Policy"})]}),(0,b.jsxs)("div",{className:"flex flex-col gap-3 sm:flex-row",children:[(0,b.jsx)("button",{type:"button",onClick:()=>j("essential"),disabled:f,className:"inline-flex min-w-[180px] items-center justify-center rounded-full border border-white/15 bg-white/5 px-5 py-3 text-sm font-semibold text-white transition hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-60",children:"Reject"}),(0,b.jsx)("button",{type:"button",onClick:()=>j("accepted"),disabled:f,className:"inline-flex min-w-[180px] items-center justify-center rounded-full bg-gradient-to-r from-tertiary to-quaternary px-5 py-3 text-sm font-semibold text-white transition hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-60",children:"Accept Cookies"})]})]})})}):null}let k=(0,e.createContext)(null),l={openPolicy:()=>{},closePolicy:()=>{}};function m({children:a}){let[h,i]=(0,e.useState)(null),l=!(0,f.usePathname)().startsWith("/admin");(0,e.useEffect)(()=>{if(!h){document.body.style.overflow="";return}let a=document.body.style.overflow,b=a=>{"Escape"===a.key&&i(null)};return document.body.style.overflow="hidden",window.addEventListener("keydown",b),()=>{document.body.style.overflow=a,window.removeEventListener("keydown",b)}},[h]);let m=(0,e.useMemo)(()=>({openPolicy:a=>i(a),closePolicy:()=>i(null)}),[]),n=h?g[h]:null;return(0,b.jsxs)(k.Provider,{value:m,children:[a,l?(0,b.jsx)(j,{openPolicy:m.openPolicy}):null,n?(0,b.jsx)("div",{className:"fixed inset-0 z-[120] flex items-center justify-center bg-black/70 px-4 py-6",onClick:()=>i(null),children:(0,b.jsxs)("div",{role:"dialog","aria-modal":"true","aria-labelledby":"policy-modal-title",className:"relative w-full max-w-5xl overflow-hidden rounded-[1rem] md:rounded-[2rem] border border-white/20 bg-primary shadow-2xl",onClick:a=>a.stopPropagation(),onKeyDown:a=>{"Escape"===a.key&&i(null)},children:[(0,b.jsxs)("div",{className:"flex items-start justify-between gap-4 border-b border-white/10 px-4 md:px-6 py-4 md:py-5 lg:px-8",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("p",{className:"text-xs uppercase tracking-[0.24em] text-secondary",children:"Legal"}),(0,b.jsx)("h2",{id:"policy-modal-title",className:"mt-2 text-xl md:text-2xl font-semibold text-white",children:n.title})]}),(0,b.jsxs)("div",{className:"flex items-center gap-2",children:[(0,b.jsxs)("button",{type:"button",onClick:()=>{if(!h)return;let a=new Blob([g[h].content],{type:"text/plain;charset=utf-8"}),b=window.URL.createObjectURL(a),c=document.createElement("a");c.href=b,c.download="terms"===h?"wiiz-terms-and-conditions.txt":"privacy"===h?"wiiz-privacy-policy.txt":"wiiz-cookie-policy.txt",document.body.appendChild(c),c.click(),document.body.removeChild(c),window.URL.revokeObjectURL(b)},className:"inline-flex h-10 items-center gap-2 rounded-full border border-white/10 px-4 text-sm font-medium text-gray-200 transition-colors hover:bg-white/10 hover:text-white",children:[(0,b.jsx)(c,{className:"h-4 w-4"}),"Download"]}),(0,b.jsx)("button",{type:"button",onClick:()=>i(null),"aria-label":"Close policy modal",className:"flex h-10 w-10 items-center justify-center rounded-full  text-gray-200 transition-colors hover:bg-white/10 hover:text-white",children:(0,b.jsx)(d.X,{className:"h-5 w-5"})})]})]}),(0,b.jsx)("div",{className:"max-h-[75vh] space-y-2 md:space-y-5 overflow-y-auto px-4 md:px-6 py-4 md:py-6 lg:px-8 [scrollbar-color:#8b3d67_#221520] [scrollbar-width:thin] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[#8b3d67] [&::-webkit-scrollbar-track]:bg-[#221520] [&::-webkit-scrollbar]:w-1.5",children:n.content.split("\n\n").map((a,c)=>{let d=a.trim();if(!d)return null;let f=d.split("\n").filter(Boolean);if(1===f.length&&/^(?:\d+(?:\.\d+)*\.?|Conclusion and Acceptance|Last Updated:)/.test(f[0])){let a=/^\d+\./.test(f[0])||"Conclusion and Acceptance"===f[0];return(0,b.jsx)("h3",{className:a?"mt-7 text-xl font-semibold text-white md:text-2xl":"mt-5 text-lg font-semibold text-white md:text-xl",children:f[0]},`${f[0]}-${c}`)}return(0,b.jsx)("div",{className:"space-y-0 md:space-y-2",children:f.map((a,d)=>{let f=a.replace(/^•\s*/,"");return/^•\s*/.test(a)||/;$/.test(a)||/:$/.test(a)||/^(?:[A-Z][A-Za-z0-9\s"()/.-]+)$/.test(a)?(0,b.jsxs)("div",{className:"flex items-start gap-2",children:[(0,b.jsx)("span",{className:"mt-3 md:h-2 h-1.5 md:w-2 w-1.5 flex-shrink-0 rounded-full bg-secondary"}),(0,b.jsx)("p",{className:"text-sm md:text-base md:leading-8 text-gray-200",children:f})]},`${c}-${d}`):(0,b.jsx)(e.Fragment,{children:(0,b.jsx)("p",{className:"text-sm md:leading-7 text-gray-300 md:text-[16px]",children:f})},`${c}-${d}`)})},`paragraph-${c}`)})})]})}):null]})}function n(){return(0,e.useContext)(k)??l}a.s(["PolicyModalProvider",()=>m,"usePolicyModal",()=>n],873)}];

//# sourceMappingURL=src_components_website_policy-modal-provider_tsx_7c3d4cef._.js.map